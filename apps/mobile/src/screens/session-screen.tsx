    ...
    >
      <View style={{ gap: 4 }}>
        <Text selectable style={{ color: "white", fontSize: 26, fontWeight: "700" }}>
          {session?.workingDir.split("/").pop() || "Session"}
        </Text>
      ...
      <View style={sectionStyle}>
        ...
        {isLoading ? <Text selectable style={mutedText}>Loading messages…</Text> : null}
      ...
      <View style={sectionStyle}>
        ...
        <Pressable
          ...
          style={primaryButton}
        >
          <Text style={primaryButtonText}>Send to desktop</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
