...
import { getPluginCategories, getPluginIntegrations } from "@/lib/plugins";
import { detectProviderSubscriptions } from "@/lib/provider-subscriptions";
import { mutationLimiter } from "@/lib/rate-limit";
import { integrationActionSchema, validateBody } from "@/lib/validation";
	...
	try {
		...
		switch (integration.id) {
			...
			case "google_workspace": {
				const credsFile = getEffectiveEnvValue(
					envMap,
