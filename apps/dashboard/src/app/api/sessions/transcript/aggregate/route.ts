	...
	switch (part.type) {
		...
		case "thinking":
			return {
				...
				role,
				type: "thinking",
				content: part.thinking.slice(0, 300),
			};
		case "tool_use":
			return {
				id,
				...
				type: "tool_use",
				content: part.name,
				metadata: { toolId: part.id, input: part.input },
			};
		case "tool_result":
			return {
				id,
				...
				role,
				type: "tool_result",
				content: part.content.slice(0, 500),
				metadata: { toolUseId: part.toolUseId, isError: part.isError },
			};
	}
}
