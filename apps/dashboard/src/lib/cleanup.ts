 ...
 * @param retentionMsOverride - Optional retention period in ms; defaults to 30 days.
 */
export async function getReplayStorageInfo(retentionMsOverride?: number): Promise<{
  ...
  const retentionMs = retentionMsOverride ?? DEFAULT_RETENTION_MS;
