...
import {
	buildTaskCostReport,
	calculateStats,
	type TaskCostMetadata,
	type TokenCostRecord,
} from "@/lib/task-costs";
		...
		const records: TokenCostRecord[] = [
			{
				model: "sonnet",
				agentName: "alpha",
				timestamp: Date.parse("2026-03-05T01:00:00Z"),
				totalTokens: 100,
				cost: 0.1,
				taskId: 101,
			},
			{
				model: "sonnet",
				agentName: "alpha",
				timestamp: Date.parse("2026-03-05T02:00:00Z"),
				totalTokens: 150,
				cost: 0.15,
				taskId: 101,
			},
			{
				model: "haiku",
				agentName: "beta",
				timestamp: Date.parse("2026-03-05T03:00:00Z"),
				totalTokens: 50,
				cost: 0.02,
				taskId: 202,
			},
			{
				model: "haiku",
				agentName: "beta",
				timestamp: Date.parse("2026-03-05T03:30:00Z"),
				totalTokens: 75,
				cost: 0.03,
			},
		];
