...
export const AGENT_TEMPLATES: AgentTemplate[] = [
	{
		...
		label: "Orchestrator",
		description:
			"Primary coordinator with full tool access. Routes tasks to specialist agents and manages workflows.",
		emoji: "\ud83e\udded",
		modelTier: "opus",
		toolCount: 23,
		config: {
	...
	},
	{
		...
		label: "Developer",
		description:
			"Full-stack builder with Docker bridge networking, exec/write access, and subagent spawning.",
		emoji: "\ud83d\udee0\ufe0f",
		modelTier: "sonnet",
		toolCount: 21,
		config: {
	...
	},
	{
		...
		description:
			"Focused developer for specific domains (frontend, backend, blockchain). Docker bridge + write access.",
		emoji: "\u2699\ufe0f",
		modelTier: "sonnet",
		toolCount: 15,
		config: {
	...
	},
	{
		...
		label: "Reviewer / QA",
		description:
			"Read-only access for code review, quality gates, and auditing. Lightweight Haiku model.",
		emoji: "\ud83d\udd2c",
		modelTier: "haiku",
		toolCount: 7,
		config: {
	...
	},
	{
		...
		label: "Researcher",
		description:
			"Browser and web access for research tasks. No workspace or code execution.",
		emoji: "\ud83d\udd0d",
		modelTier: "sonnet",
		toolCount: 8,
		config: {
	...
	},
	{
		...
		description:
			"Write and edit access for content generation. No code execution or browser.",
		emoji: "\u270f\ufe0f",
		modelTier: "haiku",
		toolCount: 9,
		config: {
	...
	},
	{
		...
		description:
			"Read-only workspace with bash for security scanning. No write access to prevent tampering.",
		emoji: "\ud83d\udee1\ufe0f",
		modelTier: "sonnet",
		toolCount: 10,
		config: {
