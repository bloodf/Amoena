...
function readSystemStats(value: unknown): SystemStats | null {
	...
	const memory =
		record.memory && typeof record.memory === "object"
			...
			: null;
	const disk =
		record.disk && typeof record.disk === "object"
			? (record.disk as Record<string, unknown>)
			: null;
...
const menuItems: MenuItem[] = [
	...
	},
	{
		...
		label: "Agent Squad",
		icon: "🤖",
		description: "Agent management & status",
	},
	{
		id: "activity",
		label: "Activity Feed",
	...
	},
	{
		...
		label: "Spawn Agent",
		icon: "🚀",
		description: "Launch new sub-agents",
	},
	{
		id: "logs",
		label: "Logs",
	...
	},
	{
		...
		label: "Channels",
		icon: "📡",
		description: "Messaging platform status",
	},
	{
		id: "nodes",
		label: "Nodes",
	...
	},
	{
		...
		label: "Approvals",
		icon: "✅",
		description: "Exec approval queue",
	},
	{
		id: "debug",
		label: "Debug",
