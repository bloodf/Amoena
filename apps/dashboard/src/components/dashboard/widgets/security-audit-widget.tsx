...
import { type DashboardData, StatRow } from "../widget-primitives";
...
export function SecurityAuditWidget({ data }: { data: DashboardData }) {
	...
	const badge = posture
		? postureBadge[posture.level] || postureBadge.secure
		: null;
		...
		<div className="panel">
			...
			<div className="panel-body space-y-3">
				...
				<StatRow
					...
					value={dbStats?.notifications.unread ?? 0}
					alert={(dbStats?.notifications.unread ?? 0) > 0}
				/>
				<button
