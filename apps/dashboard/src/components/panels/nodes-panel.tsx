				...
				{devices.map((device) => (
					...
					>
						...
						<div className="flex gap-2">
							...
							>
								{actionLoading === `approve-${device.requestId}`
									? t("approving")
									: t("approve")}
							</Button>
							<Button
							...
							>
								{actionLoading === `reject-${device.requestId}`
									? t("rejecting")
									: t("reject")}
							</Button>
						</div>
									...
									<td className="py-2">
										<div className="flex flex-col gap-1">
											<div className="flex gap-1">
												...
												>
													{actionLoading === `rotate-${deviceKey}`
														? "..."
														: t("rotateToken")}
												</Button>
												{confirmRevoke === deviceKey ? (
													<div className="flex gap-1 items-center">
														...
														>
															{actionLoading === `revoke-${deviceKey}`
																? "..."
																: t("yes")}
														</Button>
														<Button
												...
												{tokens.length > 0 && (
													<Button
														...
														onClick={() =>
															setExpandedDevice(isExpanded ? null : deviceKey)
														}
													>
														{isExpanded
															? t("hideTokens")
													...
													{tokens.map((token, i) => (
														...
														>
															...
															{token.lastUsedAtMs && (
																<span className="text-muted-foreground">
																	{t("tokenUsed", {
																		time: relativeTime(token.lastUsedAtMs),
																	})}
																</span>
															)}
															{token.revokedAtMs && (
															...
															<div className="flex gap-1 ml-auto">
																<Button
																	...
																	disabled={actionLoading !== null}
																	onClick={() =>
																		handleRotateToken(deviceKey, token.role)
																	}
																>
																	{t("rotate")}
																</Button>
																<Button
																	...
																	onClick={() =>
																		handleRevokeToken(deviceKey, token.role)
																	}
																>
																	{t("revoke")}
																</Button>
