	...
	return (
		<>
			...
			>
				...
				<div
					className={`shrink-0 py-3 flex ${sidebarExpanded ? "px-3 items-center gap-2" : "flex-col items-center"}`}
				>
					<div
			...
			<nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-card/95 backdrop-blur-lg border-t border-border safe-area-bottom">
				<div className="flex items-center justify-around px-2 py-1">
					...
					<MobileMoreMenu
						items={allNavItems.filter((i) => !i.priority)}
						activeTab={activeTab}
