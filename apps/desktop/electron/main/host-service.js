...
import { JwtAuthProvider, createApp, LocalGitCredentialProvider } from "@lunaria/host-service";
...
var createAdaptorServer = (options) => {
  ...
  const server2 = createServer$1(options.serverOptions || {}, requestListener);
  return server2;
};
...
const auth = authToken && cloudApiUrl ? new JwtAuthProvider(authToken) : void 0;
