...
import { workspaces, worktrees } from "@lunaria/local-db";
...
const WORKTREE_BASE = path.resolve(homedir(), ".amoena/worktrees");
const PROD_LOCAL_DB_PATH = path.join(homedir(), ".amoena", "local.db");
