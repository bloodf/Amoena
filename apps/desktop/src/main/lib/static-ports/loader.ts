...
import { PORTS_FILE_NAME, PROJECT_AMOENA_DIR_NAME } from "shared/constants";
...
/**
 * Load and validate static ports configuration from a worktree's .amoena/ports.json file.
 *
 ...
 *
 * @param worktreePath - Path to the workspace's worktree directory
 * @returns true if .amoena/ports.json exists
 */
