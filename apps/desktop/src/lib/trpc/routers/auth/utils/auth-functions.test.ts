...
// Mock AMOENA_HOME_DIR before importing the module
...
// Import after mocks
const { loadToken, saveToken, handleAuthCallback, parseAuthDeepLink, stateStore, authEvents, TOKEN_FILE } =
...
describe("auth-functions", () => {
	...
	describe("parseAuthDeepLink", () => {
		...
		it("returns null for wrong host", () => {
			expect(parseAuthDeepLink("amoena://settings/callback?token=t&expiresAt=e&state=s")).toBeNull();
		});
