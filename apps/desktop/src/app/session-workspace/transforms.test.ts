...
import type { AgentRecord, MessageRecord, RuntimeFileNode, SessionMemoryResponse, TranscriptEvent } from "./types";
...
describe("inferTypes", () => {
  it("returns file extension for a file node", () => {
    const node: RuntimeFileNode = { name: "main.ts", path: "/tmp/main.ts", nodeType: "file", children: [] };
  ...
  it("returns the full filename as extension when no dot separator exists", () => {
    ...
    const node: RuntimeFileNode = { name: "Makefile", path: "/Makefile", nodeType: "file", children: [] };
...
describe("countTreeItems", () => {
  ...
  it("returns 0 for empty folder", () => {
    const folder: RuntimeFileNode = { name: "empty", path: "/empty", nodeType: "folder", children: [] };
...
describe("interestingTranscriptEvent", () => {
  ...
  it("returns false for message.created", () => {
    const event: TranscriptEvent = { id: "e1", eventType: "message.created", occurredAt: "", payload: {} };
