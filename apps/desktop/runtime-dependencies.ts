...
function copyModuleSubtree(moduleName: string, filter: string[]): PackagedNodeModuleCopy {
  return {
    from: `node_modules/${moduleName}`,
    to: `node_modules/${moduleName}`,
    filter,
...
const externalizedRuntimeModules: ExternalizedRuntimeModule[] = [
  ...
  },
  {
    ...
    packagedCopies: [copyModuleSubtree('@parcel', ['watcher/**/*', 'watcher-*/**/*'])],
