...
| **Native mode** | Amoena's own agentic loop using Vercel AI SDK. Full control over agent lifecycle. |
...
| **Wrapper mode** | Mode where Amoena wraps an external CLI tool (Claude Code, OpenCode) as a GUI shell. |
