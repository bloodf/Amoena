...
- Returns:
  ```typescript
  {
    filename: string;      // e.g. "amoena-report-goal-title-2026-03-23.html"
...
<head>
  ...
  <title>Amoena Report — [goal title]</title>
  <style>/* ALL CSS INLINE HERE — no external stylesheets, no CDN links */</style>
</head>
<body>
  <!-- Header: Amoena wordmark, goal title, generated date -->
  ...
  <!-- Footer: "Generated by Amoena" + timestamp -->
</body>
</html>
```
...
- Dark color scheme matching Amoena dashboard: `#111827` body bg, `#1f2937` card bg,
...
- Start with `amoena-report-`
- Include the goal title (sanitized) and date
- End with `.html` or `.md`
- Not exceed 80 characters total

Example: `amoena-report-add-test-coverage-2026-03-23.html`
