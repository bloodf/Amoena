...
describe('SessionOptionGrid', () => {
  test('renders all work target options', () => {
    render(
      <SessionOptionGrid options={newSessionWorkTargets} selected="local" onSelect={() => {}} />,
    );
  ...
  test('fires onSelect with the option id', () => {
    const onSelect = vi.fn(() => {});
    render(
      <SessionOptionGrid options={newSessionWorkTargets} selected="local" onSelect={onSelect} />,
    );
...
describe('ModelPicker', () => {
  ...
  test('renders all model buttons', () => {
    render(<ModelPicker models={models} selectedModel="Claude 4 Sonnet" onSelect={() => {}} />);
    expect(screen.getByText('Claude 4 Sonnet')).toBeTruthy();
