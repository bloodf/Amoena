...
describe("SessionOptionGrid", () => {
  test("renders all option labels", () => {
    render(<SessionOptionGrid options={options} selected="local" onSelect={mock(() => {})} />);
  ...
  test("highlights selected option with primary border", () => {
    render(<SessionOptionGrid options={options} selected="cloud" onSelect={mock(() => {})} />);
  ...
  test("applies custom columns class", () => {
    const { container } = render(<SessionOptionGrid options={options} selected="local" columns="grid-cols-2" onSelect={mock(() => {})} />);
