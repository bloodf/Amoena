...
import { sessionTimelineCheckpoints, sessionTimelineChangedFiles, sessionTimelineDiffLines } from "./data";
...
export const Default: Story = {
  ...
  render: () => (
    <div style={{ width: 360 }} className="p-3">
      <CheckpointTree checkpoints={sessionTimelineCheckpoints} selectedCheckpoint="cp5" onSelect={fn()} />
    </div>
  ),
};
...
export const EarlyCheckpointSelected: Story = {
  ...
  render: () => (
    <div style={{ width: 360 }} className="p-3">
      <CheckpointTree checkpoints={sessionTimelineCheckpoints} selectedCheckpoint="cp2" onSelect={fn()} />
    </div>
  ),
};
...
export const BranchCheckpointSelected: Story = {
  ...
  render: () => (
    <div style={{ width: 360 }} className="p-3">
      <CheckpointTree checkpoints={sessionTimelineCheckpoints} selectedCheckpoint="cp3b" onSelect={fn()} />
    </div>
  ),
};
...
export const SingleCheckpoint: Story = {
  ...
  render: () => (
    <div style={{ width: 360 }} className="p-3">
      <CheckpointTree
        checkpoints={[{ id: "cp1", label: "Session start", timestamp: "3:42 PM", tokensUsed: "0", filesChanged: 0, isCurrent: true }]}
...
export const ChangedFilesPanelSingleFile: Story = {
  render: () => (
    <div style={{ width: 500 }} className="p-4">
      <ChangedFilesPanel files={[{ path: "src/auth/jwt.rs", additions: 142, deletions: 23, status: "modified" }]} />
    </div>
  ),
};
