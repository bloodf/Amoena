    ...
    const removeButtons = screen
      ...
      .filter(
        (b) =>
          ...
          b.textContent?.toLowerCase().includes('queue.remove'),
      );
    ...
    const editButtons = screen
      ...
      .filter(
        (b) =>
          ...
          b.textContent?.toLowerCase().includes('queue.edit'),
      );
    ...
    const saveBtn = screen
      ...
      .find(
        (b) =>
          ...
          b.textContent?.toLowerCase().includes('queue.save'),
      );
