...
const editorCanvasMeta: Meta<typeof EditorCanvas> = {
	title: "Composites/VisualEditor/EditorCanvas",
...
const editorToolbarMeta: Meta<typeof EditorToolbar> = {
	title: "Composites/VisualEditor/EditorToolbar",
...
const propertiesMeta: Meta<typeof PropertiesPanel> = {
	title: "Composites/VisualEditor/PropertiesPanel",
