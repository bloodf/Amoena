...
const pairingMeta: Meta<typeof RemotePairingPanel> = {
  title: "Composites/Remote/RemotePairingPanel",
  component: RemotePairingPanel,
  parameters: { layout: "centered" },
  decorators: [
    (Story: React.ComponentType) => (
      <div style={{ width: 400 }}>
...
const terminalMeta: Meta<typeof RemoteTerminalSettingsPanel> = {
  title: "Composites/Remote/RemoteTerminalSettingsPanel",
  component: RemoteTerminalSettingsPanel,
  parameters: { layout: "centered" },
  decorators: [
    (Story: React.ComponentType) => (
      <div style={{ width: 480 }}>
