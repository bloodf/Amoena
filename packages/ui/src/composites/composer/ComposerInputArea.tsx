    ...
    <div className="flex items-end gap-2">
      {isRecording ? (
        <div className="flex min-h-[36px] flex-1 items-center gap-3 py-2">
          <div
            className="flex items-center gap-2 rounded-full border border-destructive/20 bg-destructive/10 px-3 py-1.5"
            style={{ width: 150 }}
          >
            ...
            />
            <span className="flex-shrink-0 font-mono tabular-nums text-[10px] text-destructive">
              {recordingTime}
            </span>
          </div>
        </div>
