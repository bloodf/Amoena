...
describe("ComposerFilePicker", () => {
  ...
  test("renders file paths", () => {
    render(<ComposerFilePicker files={files} selectedIndex={0} onSelect={mock(() => {})} />);
...
describe("ComposerSkillsPicker", () => {
  ...
  test("renders skill names", () => {
    render(<ComposerSkillsPicker skills={skills} selectedIndex={0} onSelect={mock(() => {})} />);
