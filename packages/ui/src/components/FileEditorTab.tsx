...
export function FileEditorTab({ fileName, filePath, fileContent, onSaveContent }: FileEditorTabProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      <FileEditorHeader fileName={fileName} filePath={resolvedFilePath} editMode={editMode} hasUnsaved={hasUnsaved} onEdit={handleEdit} onSave={handleSave} onCancel={handleCancel} />
