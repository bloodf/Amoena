...
export function AppShell({ children, onOpenCommandPalette }: { children: ReactNode; onOpenCommandPalette?: () => void }) {
    ...
    <div className="flex h-screen w-screen flex-col overflow-hidden bg-surface-0">
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={cn(
          ...
          <SidebarRail onOpenCommandPalette={onOpenCommandPalette} onNavigate={() => isMobile && setSidebarOpen(false)} />
        </div>
