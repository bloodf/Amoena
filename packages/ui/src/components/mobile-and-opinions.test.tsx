...
describe("Lunaria mobile shell and opinions", () => {
  ...
  test("opinions screen switches categories, adds, edits, and deletes an opinion", () => {
    ...
    fireEvent.change(screen.getByPlaceholderText(/Opinion title/i), { target: { value: "Latency budget" } });
    fireEvent.change(screen.getByPlaceholderText(/Description/i), { target: { value: "Performance rule" } });
    fireEvent.change(screen.getByPlaceholderText(/Value \/ preference/i), { target: { value: "<200ms p95" } });
