...
export class SearchRoutes extends BaseRouteHandler {
	...
	setupRoutes(app: express.Application): void {
		...
		app.get(
			...
			this.handleSearchObservations.bind(this),
		);
	 ...
	 */
	private handleUnifiedSearch = this.wrapHandler(
	 ...
	 */
	private handleUnifiedTimeline = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleDecisions = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleChanges = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleHowItWorks = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleSearchObservations = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleSearchSessions = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleSearchPrompts = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleSearchByConcept = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleSearchByFile = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleSearchByType = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleGetRecentContext = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleGetContextTimeline = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleContextPreview = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 */
	private handleContextInject = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
			// Support both legacy `project` and new `projects` parameter
			const projectsParam =
				(req.query.projects as string) || (req.query.project as string);
	 ...
	 */
	private handleGetTimelineByQuery = this.wrapHandler(
		async (req: Request, res: Response): Promise<void> => {
	 ...
	 * GET /api/search/help
	 */
	private handleSearchHelp = this.wrapHandler(
			...
			res.json({
				...
				endpoints: [
					...
					},
					{
						...
						parameters: {
							concept:
								"Concept tag (required): discovery, decision, bugfix, feature, refactor",
					...
					},
					{
						...
						method: "GET",
						description:
							"Get recent session context including summaries and observations",
						parameters: {
					...
					},
					{
						...
						parameters: {
							anchor:
								'Anchor point: observation ID, session ID (e.g., "S123"), or ISO timestamp (required)',
