	...
	implements SearchStrategy
{
	...
	async search(options: StrategySearchOptions): Promise<StrategySearchResult> {
		...
		try {
			...
			logger.error(
				"SEARCH",
				"SQLiteSearchStrategy: Search failed",
				{},
				error as Error,
			);
	...
	findByConcept(
		...
		return this.sessionSearch.findByConcept(concept, {
			limit,
			project,
			dateRange,
			orderBy,
	...
	findByType(
		...
		return this.sessionSearch.findByType(type as any, {
			limit,
			project,
			dateRange,
			orderBy,
	...
	findByFile(
		...
		return this.sessionSearch.findByFile(filePath, {
			limit,
			project,
			dateRange,
			orderBy,
