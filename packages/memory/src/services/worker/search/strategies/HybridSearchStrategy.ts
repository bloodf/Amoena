...
import {
	...
	SEARCH_CONSTANTS,
	type SessionSummarySearchResult,
	...
	implements SearchStrategy
{
	...
	async findByConcept(
		...
		try {
			logger.debug("SEARCH", "HybridSearchStrategy: findByConcept", {
				concept,
			});
			...
			logger.debug(
				"SEARCH",
				"HybridSearchStrategy: Ranked by semantic relevance",
				{
			...
			logger.error(
				"SEARCH",
				"HybridSearchStrategy: findByConcept failed",
				{},
				error as Error,
			);
	...
	async findByType(
		...
		try {
			logger.debug("SEARCH", "HybridSearchStrategy: findByType", {
				type: typeStr,
			});
			...
			logger.error(
				"SEARCH",
				"HybridSearchStrategy: findByType failed",
				{},
				error as Error,
			);
	...
	async findByFile(
		...
		try {
			...
			// Step 1: SQLite metadata filter
			const metadataResults = this.sessionSearch.findByFile(
				filePath,
				filterOptions,
			);
			...
			logger.error(
				"SEARCH",
				"HybridSearchStrategy: findByFile failed",
				{},
				error as Error,
			);
