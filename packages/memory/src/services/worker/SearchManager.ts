...
import type { TimelineItem, TimelineService } from "./TimelineService.js";
...
export class SearchManager {
	...
	async search(args: any): Promise<any> {
		...
		// PATH 2: CHROMA SEMANTIC SEARCH (query text + Chroma available)
			...
			_chromaSucceeded = true; // Chroma didn't throw error
			...
			if (chromaResults.ids.length > 0) {
				...
				logger.debug(
					"SEARCH",
					dateRange
						? "Results within user date range"
						: "Results within 90-day window",
