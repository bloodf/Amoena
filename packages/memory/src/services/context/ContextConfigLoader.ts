...
export function loadContextConfig(): ContextConfig {
	...
	return {
		totalObservationCount: parseInt(
		...
		showSavingsAmount:
			settings.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT === "true",
		showSavingsPercent:
			settings.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT === "true",
		observationTypes,
		observationConcepts,
		fullObservationField: settings.CLAUDE_MEM_CONTEXT_FULL_FIELD as
			| "narrative"
			| "facts",
