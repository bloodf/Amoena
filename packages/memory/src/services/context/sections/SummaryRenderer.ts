...
export function renderSummaryFields(
	...
	if (useColors) {
		...
		output.push(
			...Markdown.renderMarkdownSummaryField(
				"Investigated",
				summary.investigated,
			),
		);
		output.push(
			...Markdown.renderMarkdownSummaryField("Learned", summary.learned),
		);
		output.push(
			...Markdown.renderMarkdownSummaryField("Completed", summary.completed),
		);
		output.push(
			...Markdown.renderMarkdownSummaryField("Next Steps", summary.next_steps),
		);
	}
