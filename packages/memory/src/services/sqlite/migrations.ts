...
export const migration002: Migration = {
	...
	down: (_db: Database) => {
		...
		console.log(
			"⚠️  Warning: SQLite ALTER TABLE DROP COLUMN not fully supported",
		);
...
export const migration003: Migration = {
    ...
    `);
		...
		console.log(
			"✅ Created streaming_sessions table for real-time session tracking",
		);
	},
...
export const migration005: Migration = {
	...
	up: (db: Database) => {
		...
		console.log(
			"✅ Dropped orphaned tables: streaming_sessions, observation_queue",
		);
	},
    ...
    `);
		...
		console.log(
			"⚠️  Recreated streaming_sessions and observation_queue (for rollback only)",
		);
	},
};
...
export const migration006: Migration = {
	...
	up: (db: Database) => {
		...
		try {
			...
			console.log(
				"⚠️  FTS5 not available on this platform — skipping FTS migration (search uses ChromaDB)",
			);
			return;
		}
    ...
    `);
		...
		console.log(
			"✅ Created FTS5 virtual tables and triggers for full-text search",
		);
	},
...
export const migration007: Migration = {
	...
	down: (_db: Database) => {
		...
		console.log(
			"⚠️  To rollback, manually recreate the observations and session_summaries tables",
		);
	},
};
